...
export function buildNationalHall(
  scene: Scene,
  room: { id: "national"; nameEn: string; nameId: string; accent: string },
  idx: number,
  ...
  layoutRoomArtifacts(scene, "national", hallArtifacts, highlight, onArtifactClick);
}
