...
export function buildModernHall(
  scene: Scene,
  room: { id: "modern"; nameEn: string; nameId: string; accent: string },
  idx: number,
  ...
  layoutRoomArtifacts(scene, "modern", hallArtifacts, highlight, onArtifactClick);
}
