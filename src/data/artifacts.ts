...
export const artifacts: Artifact[] = [
  ...
  },
  {
    ...
    "description": {
      ...
      "id": "Prasasti Kedukan Bukit ditemukan oleh C.J. Batenburg pada tanggal 29 November 1920 di Kampung Kedukan Bukit, Kelurahan 35 Ilir, Kecamatan Ilir Barat II, Palembang, Sumatera Selatan, di tepi Sungai Tatang yang mengalir ke Sungai Musi. Prasasti ini berbentuk batu kecil berukuran 45 × 80 cm, ditulis dalam aksara Pallawa, menggunakan Bahasa Melayu Kuno Prasasti ini sekarang disimpan di Museum Nasional Indonesia dengan nomor D.146."
    }
  },
  {
    "id": "crown",
    ...
    "description": {
      ...
      "id": "Kesultanan Mataram atau Kesunanan Mataram (bahasa Jawa: ꧋ꦏꦱꦸꦤꦤꦤ꧀ꦩꦠꦫꦩ꧀, Pegon: كسونانن ماتارام, translit. Kasunanan Mataram) adalah kerajaan Islam di Pulau Jawa dari akhir abad ke-16, ketika Panembahan Senapati dinobatkan menjadi raja, hingga 1755, ketika Mataram dibagi menjadi negara-negara lebih kecil dalam Perjanjian Giyanti. Kerajaan ini dipimpin oleh penguasa yang bergelar Susuhunan dari Wangsa Mataram. Sepanjang abad ke-17, tepatnya di bawah pemerintahan Sultan Agung, Mataram adalah negara terkuat yang menyatukan Pulau Jawa meliputi Jawa Barat (kecuali Banten), Jawa Tengah (termasuk Yogyakarta), Jawa Timur (termasuk Madura), Kalimantan Barat (meliputi Sukadana), Sulawesi Selatan (meliputi Makassar) hingga Sumatra (meliputi Palembang dan Jambi)."
    }
  },
  {
    "id": "borobudur",
  ...
  },
  {
    ...
    "description": {
      ...
      "id": "Perusahaan Hindia Timur Bersatu (Belanda: Vereenigde Oostindische Compagnie [vərˈeːnɪɣdə oːstˈɪndisə kɔmpɑˈɲi]; VOC [veː(j)oːˈseː]), yang umumnya dikenal sebagai Perusahaan Hindia Timur Belanda, adalah perusahaan dagang berpiagam dan salah satu perusahaan saham gabungan pertama di dunia. Didirikan pada tanggal 20 Maret 1602 oleh Dewan Negara Belanda melalui penggabungan berbagai perusahaan yang sudah ada, perusahaan ini diberi hak monopoli selama 21 tahun untuk menjalankan kegiatan perdagangan di Asia. Saham perusahaan dapat dibeli oleh warga negara Republik Belanda serta diperjualbelikan di pasar sekunder terbuka; salah satu pasar tersebut kemudian berkembang menjadi Bursa Efek Amsterdam. Perusahaan ini memiliki wewenang yang menyerupai kekuasaan pemerintah, termasuk kemampuan untuk mengobarkan perang, memenjarakan dan menghukum mati terpidana, merundingkan perjanjian, mencetak mata uang sendiri, serta mendirikan koloni."
    }
  },
  {
    "id": "diponegoro-kris",
  ...
  },
  {
    ...
    "description": {
      ...
      "id": "Lambang negara Indonesia terkenal dengan nama Garuda Pancasila. Lambang negara Indonesia berbentuk burung Garuda yang kepalanya menoleh ke sebelah kanan heraldik, perisai berbentuk menyerupai jantung yang digantung dengan rantai pada leher Garuda, dan semboyan Bhinneka Tunggal Ika yang berarti “berbeda-beda tetapi tetap satu” ditulis di atas pita yang dicengkeram oleh Garuda. Lambang negara dirancang oleh Sultan Hamid II dari Pontianak, dibantu oleh Panitia Perencana Lambang Negara. Lambang tersebut diresmikan pemakaiannya sebagai lambang negara pertama kali pada Sidang Kabinet Republik Indonesia Serikat tanggal 11 Februari 1950 dan diperkenalkan kepada publik pertama kalinya pada 15 Februari 1950."
    }
  }
];
